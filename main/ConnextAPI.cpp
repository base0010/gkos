...
//    int nonceVal = RPCToInt(&nonceStr);
	   const std::string uAddress = (const std::string)userAddress;

	    int nonceVal = lweb3->EthGetTransactionCount(&uAddress);
//	int nonceVal = lweb3->EthGetTransactionCount(&userAddress);
